...
class ActressesToMoviesImport:
    ...
    def add_actors_to_movies(cls):
        ...
        while line:
            ...
            if is_top1000:
                ...
                cls.cur.execute(
                    "INSERT INTO actor_to_movie(actor_id ,movie_id,billing_position,role_id) SELECT DISTINCT "
    ...
    def run(cls, conn):
        ...
        cls.actors = pickle.load(open('./assets/top1000Actors_serialized.txt', 'rb'))
